...
<div id="pdfviewer-container">
    <button id="prev" class="btn"><i class="icon-chevron-left"></i> <?php echo __('Previous page');?></button>
    &nbsp;
    <span>
    	<?php echo __('Showing page');?>: <b><span id="page_num"></span></b> <?php echo __('of');?> <b><span id="page_count"></span></b>
    </span>
    &nbsp;
    <button id="next" class="btn"><?php echo __('Next page');?> <i class="icon-chevron-right"></i></button>
...
<script type="text/javascript">
  ...
  if ('' == '<?php echo $pdfurl; ?>'){
    ...
    //PDFJS.workerSrc = 'http://localhost/cakephp/pdf_viewer/js/pdf.worker.js';
